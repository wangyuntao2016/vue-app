    ...
    <div class="seller-content">
      <div class="overview">
        ...
        <div class="favorite" @click="toggleFavorite">
          ...
          <span class="text" id="favorited">{{favorite ? '已收藏' : '收藏'}}</span>
        </div>
      </div>
  ...
  export default{
    ...
    methods: {
      ...
      toggleFavorite(){
       ...
       /* // 当点击收藏时，文本跟换为 已收藏  方法一
        const favorited=document.getElementById('favorited')
        if(!this.favorite){
           console.log(this.favorite)
          favorited.innerHTML="收藏"
        }else{
          console.log(this.favorite)
          favorited.innerHTML="已收藏"
        }*/
